...
import {
    handleGetUsers, handleFindUsers,
    handleCreateUsers, handleEditUsers, handleDelUsers
} from './usersSaga';
import * as ActionTypeUserRoles from '../../constant/users/user-rolesConstant';
import {
    handleGetUserRoles, handleFindUserRoles,
    handleCreateUserRoles, handleEditUserRoles, handleDelUserRoles
} from './user-rolesSaga';
import * as ActionTypeUserProfiles from '../../constant/users/user-profilesConstant';
import {
    handleGetUserProfiles, handleFindUserProfiles,
    handleCreateUserProfiles, handleEditUserProfiles, handleDelUserProfiles
} from './user-profilesSaga';
import * as ActionTypeUserPassword from '../../constant/users/user-passwordConstant';
import {
    handleGetUserPassword, handleFindUserPassword, handleCreateUserPassword,
    handleEditUserPassword, handleDelUserPassword
} from './user-passwordSaga';
import * as ActionTypeUserMembers from '../../constant/users/user-membersConstant';
import {
    handleGetUserMembers, handleFindUserMembers, handleCreateUserMembers,
    handleEditUserMembers, handleDelUserMembers
} from './user-membersSaga';
import * as ActionTypeUserBonusPoints from '../../constant/users/user-bonus-pointsConstant';
import {
    handleGetUserBonusPoints, handleFindUserBonusPoints, handleCreateUserBonusPoints,
    handleEditUserBonusPoints, handleDelUserBonusPoints
} from './user-bonus-pointsSaga';
